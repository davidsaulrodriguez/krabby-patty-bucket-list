...
1. Fork the project (```https://github.com/davidsaulrodriguez/krabby-patty-bucket-list```)
2. Clone it on your machine (```git clone https://github.com/yourUsername/krabby-patty-bucket-list.git```)
3. Add the upstream remote (```git remote add upstream https://github.com/davidsaulrodriguez/krabby-patty-bucket-list.git```)
